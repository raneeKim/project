...
def select_first(driver):
    first = driver.find_element(By.CSS_SELECTOR,"_abm0")
    '''
    except:
        first = driver.find_elements(By.CSS_SELECTOR, "._aawg")[1] # 2022/01/11 수정
    '''
    label_0=first.get_attribute('aria-label')
    print(label_0)  
...
# 함수 정의: 첫 번째 게시물 클릭 후 다음 게시물 클릭
def move_next(driver):
    right = driver.find_element(By.CSS_SELECTOR, '._abm0') # 2022/01/11 수정
    right.click()
    time.sleep(3)
